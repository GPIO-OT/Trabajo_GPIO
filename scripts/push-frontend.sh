...
REGION="us-east-1"
REPO_NAME="backend-web-frontend"
IMAGE_TAG="latest"

aws ecr get-login-password --region $REGION | docker login --username AWS --password-stdin $AWS_ACCOUNT_ID.dkr.ecr.$REGION.amazonaws.com

docker buildx build --platform linux/amd64 -t $REPO_NAME "$PROJECT_ROOT/Frontend" --load
...
echo "Imagen del frontend subida correctamente"
